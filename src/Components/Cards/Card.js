...
export default function Card(props) {
  return (
    <div className='col col-md-4 w-50 my-2 box'>
    <div className="card "  >
    <img className="card-img-top w-100 img-fluid" src={props.url?props.url:'https://profootballtalk.nbcsports.com/wp-content/uploads/sites/25/2022/04/GettyImages-1389231641-e1650444900367.jpg'} alt="Card cap" />
